Public Class Hero_Listitem_List
  Inherits List(Of ctrlHero_List_Item)

  'used to keep track of whether we need to resort
  Private currentcount As Integer = 0

  Public Function GetSortedList() As Hero_Listitem_List
  ...
  Private Shared Function CompareItemsByName( _
        x As ctrlHero_List_Item,  y As ctrlHero_List_Item) As Integer
