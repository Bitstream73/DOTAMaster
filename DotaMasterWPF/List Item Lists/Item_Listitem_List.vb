Public Class Item_Listitem_List


  Inherits List(Of ctrlitem_List_Item)

  'used to keep track of whether we need to resort
  Private currentcount As Integer = 0

  Public Function GetSortedList() As Item_Listitem_List
  ...
  'Public Function GetSortedList() As List(Of ctrlitem_List_Item)
  '  Return fu.Sort(Function(x As ctrlitem_List_Item, y As ctrlitem_List_Item)
  ...
  Private Shared Function CompareItemsByName( _
        x As ctrlitem_List_Item,  y As ctrlitem_List_Item) As Integer
