...
Public Class ctrlItem_Details
  ...
  Public Sub New(curtime As ddFrame, _
    ...
    Me.mID = New dvID(Guid.NewGuid, "ctrlItem_Details", eEntity.ctrlItem_Detials)
    ...
    mTitle = mitem.ParentGameEntity.DisplayName & "'s " & mitem.DisplayName & " Item at "
  ...
  Private Sub LoadMods()
    ...
    Dim ownersteam = mGame.GetTeamFromGameEntity(mitem.ParentGameEntity)

    Dim mods = mGame.dbModifiers.GetModsBySource(mitem)
  ...
  Public Property EntityName As eEntity Implements iGameEntity.EntityName
    Get
      Return eEntity.ctrlItem_Detials
    End Get
