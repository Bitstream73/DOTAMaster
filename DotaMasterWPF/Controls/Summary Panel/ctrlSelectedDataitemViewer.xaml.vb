Public Class ctrlSelectedDataitemViewer
  Implements iControlIO, iGraphable

  Private mDataitems As New Dictionary(Of iDataItem, ctrlSwatchDataItemLabel)
  ...
  Private mHoveredDataItemLabel As ctrlSwatchDataItemLabel
  Private mGraphedDataItemLabel As ctrlSwatchDataItemLabel
  ...
  Public ReadOnly Property GraphSelectedDataItemViewer As ctrlSwatchDataItemLabel
    Get
      Return mGraphedDataItemLabel
    End Get
  End Property

  Public Sub AddDataitem(dataitem As iDataItem)

    Dim teamcolor As New SolidColorBrush(mGame.GetTeamFromGameEntity(dataitem.ParentGameEntity).MyColor)

    Dim ctrl = PageHandler.dbControls.GetctrlSwatchDataItemLabel(mGame.TimeKeeper.CurrentTime, _
                                                                 dataitem, dataitem.DisplayName, "")


    mDataitems.Add(dataitem, ctrl)
  End Sub
