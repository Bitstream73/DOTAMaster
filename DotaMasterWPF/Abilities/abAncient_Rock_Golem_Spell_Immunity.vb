Public Class abAncient_Rock_Golem_Spell_Immunity
  ...
  Public Sub New()
    ...
    mName = eAbilityName.abAncient_Rock_Golem_Spell_Immunity
    Me.EntityName = eEntity.abAncient_Rock_Golem_Spell_Immunity

    'mFriendlyName =PageHandler.dbAbilities.GetFriendlyName(mName)
    ParentGameEntityType = eUnit.untAncient_Rock_Golem
