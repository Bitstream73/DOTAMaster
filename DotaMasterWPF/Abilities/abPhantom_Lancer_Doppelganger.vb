Public Class abDoppelganger
  ...
  Public Sub New()
    ...
    mDisplayName = "Doppelganger"
    mName = eAbilityName.abDoppelganger
    Me.EntityName = eEntity.abDoppelganger
  ...
  Public Overrides Function GetActiveModifiers(thestateindex As Integer, thegame As dGame, theability_InfoID As IUnitUpgrade, _
    ...
    Dim illdamval As New modValue(illdamage, eModifierType.RightClickDamagePercentSubtracted, occurencetime, aghstime)
