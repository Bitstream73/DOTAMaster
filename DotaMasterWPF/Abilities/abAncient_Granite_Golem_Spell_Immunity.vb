Public Class abAncient_Granite_Golem_Spell_Immunity
  ...
  Public Sub New()
    ...
    mName = eAbilityName.abAncient_Granite_Golem_Spell_Immunity
    Me.EntityName = eEntity.abAncient_Granite_Golem_Spell_Immunity
