Public Class abAncient_Rumblehide_Spell_Immunity
  ...
  Public Sub New()
    ...
    mName = eAbilityName.abAncient_Rumblehide_Spell_Immunity
    Me.EntityName = eEntity.abAncient_Rumblehide_Spell_Immunity

    'mFriendlyName =PageHandler.dbAbilities.GetFriendlyName(mName)
    ParentGameEntityType = eUnit.untAncient_Rumblehide
