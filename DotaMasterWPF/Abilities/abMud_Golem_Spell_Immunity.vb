Public Class abMud_Golem_Spell_Immunity
  ...
  Public Sub New()
    ...
    mName = eAbilityName.abMud_Golem_Spell_Immunity
    Me.EntityName = eEntity.abMud_Golem_Spell_Immunity

    ''mFriendlyName = =PageHandler.dbAbilities.GetFriendlyName(mName)
    ParentGameEntityType = eUnit.untMud_Golem
    ...
    WebpageLink = "http://dota2.gamepedia.com/Mud_Golem"
