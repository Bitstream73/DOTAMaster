Public Class itmRecipe_Urn_Of_Shadows
  Inherits ItemBase

  Public Sub New(theparent As idisplayunit, parentorbuildname As String)
    MyBase.New(theparent, parentorbuildname)
    mName = eItemname.itmRECIPE_URN_OF_SHADOWS
    Me.EntityName = eEntity.itmRECIPE_URN_OF_SHADOWS

    mDisplayName = "Urn of Shadows Recipe"
    Description = ""
