Public Class itmRecipe_Mask_Of_Madness
  Inherits ItemBase

  Public Sub New(theparent As idisplayunit, parentorbuildname As String)
    MyBase.New(theparent, parentorbuildname)
    mName = eItemname.itmRECIPE_MASK_OF_MADNESS
    Me.EntityName = eEntity.itmRECIPE_MASK_OF_MADNESS

    mDisplayName = "Mask of Madness Recipe"
    Description = ""
