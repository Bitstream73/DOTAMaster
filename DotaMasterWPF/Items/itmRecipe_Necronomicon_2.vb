Public Class itmRecipe_Necronomicon_2
  Inherits ItemBase

  Public Sub New(theparent As idisplayunit, parentorbuildname As String)
    MyBase.New(theparent, parentorbuildname)
    mName = eItemname.itmRECIPE_NECRONOMICON_2
    Me.EntityName = eEntity.itmRECIPE_NECRONOMICON_2

    mDisplayName = "Necronomicon Lvl 2 Recipe"
    Description = ""
