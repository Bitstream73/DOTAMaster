Public Class itmRecipe_Null_Talisman
  Inherits ItemBase

  Public Sub New(theparent As idisplayunit, parentorbuildname As String)
    MyBase.New(theparent, parentorbuildname)
    mName = eItemname.itmRECIPE_NULL_TALISMAN

    Me.EntityName = eEntity.itmRECIPE_NULL_TALISMAN

    mDisplayName = "Null Talisman Recipe"
    Description = ""
