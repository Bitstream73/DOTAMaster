Public Class itmRecipe_Heart_Of_Tarrasque
  Inherits ItemBase

  Public Sub New(theparent As idisplayunit, parentorbuildname As String)
    MyBase.New(theparent, parentorbuildname)
    mName = eItemname.itmRECIPE_HEART_OF_TARRASQUE
    Me.EntityName = eEntity.itmRECIPE_HEART_OF_TARRASQUE

    mDisplayName = "Heart of Tarrasque Recipe"
    Description = ""
