Public Class itmNecronomicon_2
  Inherits ItemBase
  ...
  Public Sub New(theparent As idisplayunit, parentorbuildname As String)
    ...
    mName = eItemname.itmNECRONOMICON_2
    Me.EntityName = eEntity.itmNECRONOMICON_2

    mDisplayName = "Necronomicon (2)"
    'mDescription = "Considered the holy grail of necromancy and demonology, a powerful malefic force is locked within its pages. "
    mGoldCost = New ValueWrapper(3950)
    ...
    mBuildsToNames.Add(eItemname.itmNECRONOMICON_3)

    mCategory = eItemCategory.CASTER

    mSoldFrom.Add(eShopTypes.Fountain)

    ImageURL = "http://hydra-media.cursecdn.com/dota2.gamepedia.com/1/1c/Necronomicon_2_icon.png?version=0db148efda172f61c1fa2540d3c216f0"
    mTier = 3
    mIsRecipe = False
  ...
  Public Overrides Function GetPassiveModifiers(thestateindex As Integer, thegame As dGame, theitem_InfoID As iUnitUpgrade, _
    ...
    Dim intval As New modValue(21, eModifierType.IntAdded, occurencetime)
    ...
    Dim strval As New modValue(12, eModifierType.StrAdded, occurencetime)
  ...
  Public Overrides Function GetActiveModifiers(thestateindex As Integer, thegame As dGame, theitem_InfoID As iUnitUpgrade, _
    ...
    Dim damval As New modValue(50, eModifierType.DamagePhysicalAdded, occurencetime)
    ...
    Dim unittargetenemytargetinfo2 = Helpers.GetUnitTargetEnemyTargetInfo(theitem_InfoID, _
                                                                         thecaster, _
                                                                         thetarget, _
                                                                         "Archer damage", eModifierCategory.Active)

    Dim damval2 As New modValue(80, eModifierType.DamagePhysicalAdded, occurencetime)
