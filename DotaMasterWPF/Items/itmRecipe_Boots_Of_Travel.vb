Public Class itmRecipe_Boots_Of_Travel
  Inherits ItemBase

  Public Sub New(theparent As idisplayunit, parentorbuildname As String)
    MyBase.New(theparent, parentorbuildname)
    mName = eItemname.itmRECIPE_BOOTS_OF_TRAVEL
    Me.EntityName = eEntity.itmRECIPE_BOOTS_OF_TRAVEL

    mDisplayName = "Boots of Travel Recipe"
    Description = ""
