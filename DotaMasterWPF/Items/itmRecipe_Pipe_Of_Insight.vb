Public Class itmRecipe_Pipe_Of_Insight
  Inherits ItemBase

  Public Sub New(theparent As idisplayunit, parentorbuildname As String)
    MyBase.New(theparent, parentorbuildname)
    mName = eItemname.itmRECIPE_PIPE_OF_INSIGHT
    Me.EntityName = eEntity.itmRECIPE_PIPE_OF_INSIGHT

    mDisplayName = "Pipe of Insight Recipe"
    Description = ""
